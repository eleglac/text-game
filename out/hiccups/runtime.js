...
var _STAR_html_mode_STAR_7853 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_7853;
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__7854){
var vec__7856 = p__7854;
var name = cljs.core.nth.call(null,vec__7856,(0),null);
var value = cljs.core.nth.call(null,vec__7856,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null))){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__7857){
var vec__7860 = p__7857;
var tag = cljs.core.nth.call(null,vec__7860,(0),null);
var content = cljs.core.nthnext.call(null,vec__7860,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__7861 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__7861,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__7861,(1),null);
var id = cljs.core.nth.call(null,vec__7861,(2),null);
var class$ = cljs.core.nth.call(null,vec__7861,(3),null);
...
var vec__7863 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__7863,(0),null);
var attrs = cljs.core.nth.call(null,vec__7863,(1),null);
var content = cljs.core.nth.call(null,vec__7863,(2),null);
if(cljs.core.truth_((function (){var or__5862__auto__ = content;
